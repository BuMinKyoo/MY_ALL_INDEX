  ...
  - 선형 회귀(Linear regression)
    ...
    - 최적의 a,b찾기
      ...
      - 선형 회귀의 목적은 Loss를 최소화 하는 weight와 bias를 구하는 것
        - 비효율적이며, 모든 경우의 수를 일일이 대입해서 최적값을 찾는 방식은 현실적으로 불가능 => 해결책 : Gradient descent
...
<br/>
  ...
  - Gradient descent
    ...
    - Gradient는 항상 가장 가파른곳을 향하는 공식이다
      ...
      - 이걸 수식으로 하면 결국 Gradient descent 수식이 나오고 이게 결국 딥러닝 수식의 기초가 된다
...
<br>
  ...
  - Gradient descent 단점 2가지
    - Gradient descent 한 스텝을 하는데 즉,loss를 구하기 위해, 모든 파라미터를 다 더하고 곱하고 해야하기 때문에 연산이 많고 느리다
