...
~~~
  ...
  - DOS함수든, BIOS함수든, 소프트웨어 인터럽트를 발생시켜서 함수를 사용하러 점프하게 된다
...
# 인터럽트
  ...
  - 크게 두 가지 종류
      - 하드웨어 인터럽트 : 외부 장치가 인터럽트 핀을 통해 요청
        ...
        - 하드웨어 인터럽트는 외부 장치 또는 하드웨어에서 생성되는 인터럽트, 키보드 입력, 마우스 클릭, usb장치, nic카드 등
  ...
  - 소프트웨어 인터럽트
    ...
    - 실행할 함수는 테이블에 저장되어 있음
      - 변경 가능
      - 사실상 함수 포인터
    - 소프트웨어 인터럽트는 응용 프로그램이 종료 또는 예외처리 되거나 운영체제에 서비스를 요청할 때 발생, 소프트웨어 인터럽트는 커널과 통신해 간접적으로 중앙 처리 장치를 인터럽트 한다
  - 8088의 인터럽트
